...
module.exports = SuperJS.Application.extend({
  ...
  loadControllers: function() {
    ...
    self.loadController('default', self.paths.cwd + 'node_modules/superjs-api/apis/default/controller');
    ...
    if( fs.existsSync(self.paths.cwd + '/apis') ) {
      ...
      modules.map(function(apiName) {
        ...
        self.loadController(apiName, self.paths.cwd + 'apis/' + apiName + '/controller');
  ...
  loadController: function(controllerName, controllerPath) {
    ...
    if( fs.existsSync(controllerPath + '/class.js') ) {
      ...
      var Controller = require(controllerPath + '/class');
