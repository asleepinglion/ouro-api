      ...
      .then(function() {
        ...
        if( !res.responded ) {
          ...
          return self.controllers[req.controller].beforeAction(req)
            ...
            .then(function(response) {
              if( self.controllers[req.controller]['before' + req.action.substr(0,1).toUpperCase()+req.action.substr(1,req.action.length-1)] ) {
                return self.controllers[req.controller]['before' + req.action.substr(0,1).toUpperCase()+req.action.substr(1,req.action.length-1)](req);
              } else {
                return {};
              }
            })
            ...
            .then(function(response) {
              if( self.controllers[req.controller]['after' + req.action.substr(0,1).toUpperCase()+req.action.substr(1,req.action.length-1)] ) {
                return self.controllers[req.controller]['after' + req.action.substr(0,1).toUpperCase()+req.action.substr(1,req.action.length-1)](req, res);
              } else {
                return {};
              }
            })
