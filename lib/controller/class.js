      ...
      for( var param in this.meta.methods[method].params ) {
        ...
        for( var validation in this.meta.methods[method].params[param].validate ) {
          ...
          if( typeof this.validate[validation] !== 'function') {
            this.log.warn('validation missing:',{validation: validation, controller: this.name, method: method, parameter: param});
                    ...
                    for( var attribute in controller.model.attributes ) {
                      ...
                      for( var validation in controller.meta.methods[method].params[param].model.validate[attribute] ) {
                        ...
                        if( !this.validate[validation] ) {
                          ...
                          delete controller.meta.methods[method].params[param].model.validate[attribute][validation];
                        }
                      }
                    }
                  }
